...
public class StudentView implements View {
    ...
    public static StudentView instance = new StudentView();
    ...
    public void injectContentIntoCluster(String personId) {
        ...
        userNode.getChildren().addAll(UserIconCreator.createUserIcon(personId, usernameText.getText()),
                usernameText, BadgeFactory.createBadge("STUDENT"));
        ...
        appCluster.setCenter(StudentProfileComponent.instance.createComponent(personId));
        ...
        courses.setOnMouseClicked(e -> {
            ...
            appCluster.setCenter(StudentClassroomComponent.instance.createComponent(personId));
        ...
        homeworks.setOnMouseClicked(e -> {
            ...
            appCluster.setCenter(StudentHomeworkComponent.instance.createComponent(personId));
            ViewPurger.setColorForIconText(profile, "transparent");
            ViewPurger.setColorForIconText(courses, "transparent");
        ...
        documents.setOnMouseClicked(e -> {
            ...
            appCluster.setCenter(StudentDocumentsComponent.instance.createComponent(personId));
            ViewPurger.setColorForIconText(profile, "transparent");
            ViewPurger.setColorForIconText(courses, "transparent");
            ViewPurger.setColorForIconText(homeworks, "transparent");
        ...
        announcements.setOnMouseClicked(e -> {
            ...
            appCluster.setCenter(StudentAnnouncementComponent.instance.createComponent(personId));
            ViewPurger.setColorForIconText(profile, "transparent");
            ViewPurger.setColorForIconText(courses, "transparent");
            ViewPurger.setColorForIconText(homeworks, "transparent");
            ViewPurger.setColorForIconText(documents, "transparent");
